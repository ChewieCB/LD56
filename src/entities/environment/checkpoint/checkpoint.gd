...
func _ready() -> void:
	...
	if name in GameManager.checkpoint_activated_name_list:
		activated = true
		flag_sprite.self_modulate = Color.GREEN
...
func activate_checkpoint():
	...
	GameManager.checkpoint_activated_name_list.append(name) # Try to keep checkpoints have different name
